...
public class form_di_segnalazioneLocalServiceUtil {
	...
	*/
	...
	public static form_di_segnalazioneLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					form_di_segnalazioneLocalService.class.getName());

			if (invokableLocalService instanceof form_di_segnalazioneLocalService) {
				_service = (form_di_segnalazioneLocalService)invokableLocalService;
			}
			else {
				_service = new form_di_segnalazioneLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(form_di_segnalazioneLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(form_di_segnalazioneLocalService service) {
	}

	private static form_di_segnalazioneLocalService _service;
}