package com.archivio_delle_segnalazioni;
...
/**
 * Portlet implementation class Archivio_delle_segnalazioniPortlet
 */
public class Archivio_delle_segnalazioniPortlet extends MVCPortlet {
	private static Log logger = LogFactoryUtil.getLog(Archivio_delle_segnalazioniPortlet.class);
	 ...
	 public void updateRecord(ActionRequest actionRequest, ActionResponse actionResponse)
	   throws IOException, PortletException, PortalException, NumberFormatException, SystemException {
	    ...
	    if(!(ParamUtil.getString(actionRequest, "CODICE").equalsIgnoreCase("")) && !(ParamUtil.getString(actionRequest, "INIZIALI_1").equalsIgnoreCase(""))){
		    ...
		    actionResponse.setRenderParameter("jspPage", "/html/archivio_delle_segnalazioni/Form_di_segnalazione_Edit.jsp");
		    logger.info("Data:-"+e);
	    }
