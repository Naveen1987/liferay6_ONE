...
Folder folder=fb.getFolder(themeDisplay, "Manuali");
%>
...
<thead>
<tr> 
<th width="10%"><b>Applicativo</b></th>
<th width="30%"><b>Titolo</b></th>
<th width="20%"><b>Spec</b></th>
<th width="10%"><b>Dimensione</b></th>
...
%>
<tr>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Applicativo")%></aui:a></td>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("title")%></aui:a></td>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Spec")%></aui:a></td>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Dimensione")%></aui:a></td>
<td>
