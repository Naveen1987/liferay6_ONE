...
/**
 * Provides the local service interface for Telephonic. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Administrator
 * @see TelephonicLocalServiceUtil
...
public interface TelephonicLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TelephonicLocalServiceUtil} to access the telephonic local service. Add custom service methods to {@link com.liferay.sample.service.impl.TelephonicLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
