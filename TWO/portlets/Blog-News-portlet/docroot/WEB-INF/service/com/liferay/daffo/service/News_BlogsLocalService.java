...
/**
 * Provides the local service interface for News_Blogs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Naveen Kumar
 * @see News_BlogsLocalServiceUtil
...
public interface News_BlogsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link News_BlogsLocalServiceUtil} to access the news_ blogs local service. Add custom service methods to {@link com.liferay.daffo.service.impl.News_BlogsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
