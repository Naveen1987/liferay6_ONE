...
Folder folder=fb.getFolder(themeDisplay, "Documenti di dipartimento");
%>
...
<th width="35%"><b>TITOLO</b></th>
<th width="10%"><b>REV</b></th>
<th width="15%"><b>Dipartimento</b></th>
...
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Dipartimento")%></aui:a></td>
<td>
