...
Folder folder=fb.getFolder(themeDisplay, "Farmacia");
%>
...
<img src="<%=renderRequest.getContextPath()%>/images/<%=values.get("icon")%>" style="width:25px;height: 25px" alt='<%=values.get("extension")%> file'/>
<%=values.get("size")%>
</aui:a>
</td>
