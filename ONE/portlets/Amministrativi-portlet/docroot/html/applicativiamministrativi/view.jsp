...
<table border="0" cellpadding="3" cellspacing="0">
	<tbody>
		<tr onclick="HideA('dettaglioOracle')">
			...
			<td style="width: 36px;"><img src="<%=request.getContextPath().toString()%>/img/oracle.jpg" style="border-width: 0px; border-style: solid; width: 37px; height: 36px;"/></td>
		...
		<tr>
			<td><a href="http://le-porpiu-01.aol.it:8081/AOLRR/home.summer" target="_blank"><img src="<%=request.getContextPath().toString()%>/img/porta.jpg" style="border-width: 0px; border-style: solid; width: 37px; height: 36px;" /></a></td>
		...
		<tr>
			<td><a href="http://le-folium-01.aol.it:8080/Folium/index.do" target="_blank"><img src="<%=request.getContextPath().toString()%>/img/folium.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 34px;" /></a></td>
		...
		<tr>
			<td><a href="http://le-civilia-01.aol.it:18080/portal/" target="_blank"><img src="<%=request.getContextPath().toString()%>/img/civilia.jpg" style="border-width: 0px; border-style: solid; width: 30px; height: 36px;" /></a></td>
		...
		<tr>
			<td><a href="http://ma-prdeus-01.aol.it:8080/Portale" target="_blank"><img alt="" src="<%=request.getContextPath().toString()%>/img/eusis.jpg" style="height: 35px; width: 36px;" /></a></td>
