	...
	<tbody>
		<tr>
			...
			<table border="0" cellpadding="3" cellspacing="0">
				<tbody>
					<tr>
						<td><a href="http://curedomiciliari.aslmi1.mi.it/servizi/autorizzazioni/login_fase01.aspx?" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/cure_domiciliari.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></a></td>
					...
					<tr>
						<td><a href="http://le-consul-00.aol.it:8080/SIT/jsp/login.jsp" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/consultori.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 32px;" /></a></td>
					...
					<tr>
						<td><a href="http://le-dipend-00.aol.it/mfp5web/mfp5menu.aspx" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/dipendenze.jpg" style="border-width: 0px; border-style: solid; width: 28px; height: 36px;" /></a></td>
					...
					<tr>
						<td><a href="http://le-visite-00.aol.it/DSPVisiteFiscali/" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/visite_fiscali.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></a></td>
					...
					<tr>
						<td><a href="https://trapianti.sanita.it/consensi/Pelogin.asp" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/consenso_trapianti.jpg" style="border-width: 0px; border-style: solid; width: 29px; height: 36px;" /></a></td>
			...
			<table border="0" cellpadding="3" cellspacing="0">
				<tbody>
					<tr onclick="HideS('dettaglioINPS')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/inps.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></td>
						<td><b>INPS</b><br />
					...
					<tr>
						<td><a href="http://le-medleg-00.aol.it:8085/asterLogin/login" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/invalidita_civilw.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 30px;" /></a></td>
					...
					<tr onclick="HideS('dettaglioSANITA')">
						<td style="width: 36px;"><img src="<%=renderRequest.getContextPath().toString()%>/img/screening.jpg" style="border-width: 0px; border-style: solid; width: 35px; height: 36px;" /></td>
					...
					<tr>
						<td><a href="http://pianiterapeutici.aslmi1.mi.it/" target="_blank"><img src="<%=renderRequest.getContextPath().toString()%>/img/piani_terapeutici.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 31px;" /></a></td>
					...
					<tr onclick="HideS('dettaglioPROTESI')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/protesica.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 34px;" /></td>
						<td><b>PROTESICA</b><br />
					...
					<tr onclick="HideS('dettaglioVACCINAZIONI')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/vaccinazioni.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 30px;" /></td>
