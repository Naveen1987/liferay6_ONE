...
Folder folder=fb.getFolder(themeDisplay, "Customer Satisfaction");
%>
...
<thead>
<tr> 
<th width="10%"><b>Anno</b></th>
<th width="35%"><b>Sede</b></th>
<th width="20%"><b>Data modificata</b></th>
<th width="20%"><b>Dimensioni</b></th>
<th width="15%"><b>Unità organizzativa</b></th>
</tr>
...
%>
<tr>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Anno")%></aui:a></td>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Sede")%></aui:a></td>
...
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("UnitaOrganizzativa")%></aui:a></td>
</tr>	
<%
}
%>
