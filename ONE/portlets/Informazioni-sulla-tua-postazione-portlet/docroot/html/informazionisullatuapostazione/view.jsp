...
<%@page import="com.liferay.portal.kernel.util.InetAddressUtil"%>
<div style="height:100px; overflow:auto;">
<table cellpadding="6" cellspacing="1" style="width: 100%" class="table table-bordered table-hover">
<tbody>
	<tr>
	<td><%=InetAddressUtil.getLocalInetAddress()%></td>
	</tr>
	<tr>
	<td><%=InetAddressUtil.getLocalHostName()%></td>
	</tr>
		<tr>
			<td id="agent">&nbsp;</td>
		</tr>
