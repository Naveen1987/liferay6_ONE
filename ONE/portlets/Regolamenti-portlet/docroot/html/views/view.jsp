...
Folder folder=fb.getFolder(themeDisplay, "Regolamenti");
%>
...
<thead>
<tr> 
<th width="10%"><b>Numero</b></th>
<th width="40%"><b>Modulo</b></th>
<th width="25%"><b>Data modificata</b></th>
<th width="25%"><b>Dimensioni</b></th>
</tr>
...
%>
<tr>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Numero")%></aui:a></td>
<td><aui:a href='<%=values.get("url")%>' style="color:black;text-decoration:none;"><%=values.get("Modulo")%></aui:a></td>
