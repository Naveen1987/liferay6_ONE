...
import com.liferay.sample.NoSuchsuiluppo_roomException;
import com.liferay.sample.model.impl.suiluppo_roomImpl;
import com.liferay.sample.model.impl.suiluppo_roomModelImpl;
...
public class suiluppo_roomPersistenceImpl extends BasePersistenceImpl<suiluppo_room>
	...
	public void cacheResult(suiluppo_room suiluppo_room) {
		EntityCacheUtil.putResult(suiluppo_roomModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		if (_HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE) {
			CacheRegistryUtil.clear(suiluppo_roomImpl.class.getName());
		}

		EntityCacheUtil.clearCache(suiluppo_roomImpl.class.getName());
	...
	public void clearCache(suiluppo_room suiluppo_room) {
		EntityCacheUtil.removeResult(suiluppo_roomModelImpl.ENTITY_CACHE_ENABLED,
			suiluppo_roomImpl.class, suiluppo_room.getPrimaryKey());
	 ...
	 * @throws com.liferay.sample.NoSuchsuiluppo_roomException if a suiluppo_room with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public suiluppo_room remove(long roomID)
		throws NoSuchsuiluppo_roomException, SystemException {
	...
	@Override
	public suiluppo_room updateImpl(
	...
	/**
	 * Returns the suiluppo_room with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the suiluppo_room
	...
	/**
	 * Returns the suiluppo_room with the primary key or throws a {@link com.liferay.sample.NoSuchsuiluppo_roomException} if it could not be found.
	 *
	 * @param roomID the primary key of the suiluppo_room
	 * @return the suiluppo_room
	 * @throws com.liferay.sample.NoSuchsuiluppo_roomException if a suiluppo_room with the primary key could not be found
	...
	public suiluppo_room fetchByPrimaryKey(Serializable primaryKey)
		throws SystemException {
		suiluppo_room suiluppo_room = (suiluppo_room)EntityCacheUtil.getResult(suiluppo_roomModelImpl.ENTITY_CACHE_ENABLED,
				suiluppo_roomImpl.class, primaryKey);

		if (suiluppo_room == _nullsuiluppo_room) {
			return null;
		}
		...
		if (suiluppo_room == null) {
			...
			try {
				...
				if (suiluppo_room != null) {
					...
					EntityCacheUtil.putResult(suiluppo_roomModelImpl.ENTITY_CACHE_ENABLED,
						suiluppo_roomImpl.class, primaryKey, _nullsuiluppo_room);
				}
			}
			catch (Exception e) {
				EntityCacheUtil.removeResult(suiluppo_roomModelImpl.ENTITY_CACHE_ENABLED,
	 ...
	 */
	@Override
	public List<suiluppo_room> findAll() throws SystemException {
	...
	public List<suiluppo_room> findAll(int start, int end,
		...
		List<suiluppo_room> list = (List<suiluppo_room>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<suiluppo_room>(list);
				}
				else {
					list = (List<suiluppo_room>)QueryUtil.list(q, getDialect(),
							start, end);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.sample.model.suiluppo_room")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<suiluppo_room>> listenersList = new ArrayList<ModelListener<suiluppo_room>>();

				for (String listenerClassName : listenerClassNames) {
					listenersList.add((ModelListener<suiluppo_room>)InstanceFactory.newInstance(
	...
	public void destroy() {
		EntityCacheUtil.removeCache(suiluppo_roomImpl.class.getName());
	...
	private static Log _log = LogFactoryUtil.getLog(suiluppo_roomPersistenceImpl.class);
	private static suiluppo_room _nullsuiluppo_room = new suiluppo_roomImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<suiluppo_room> toCacheModel() {
				return _nullsuiluppo_roomCacheModel;
			}
		};

	private static CacheModel<suiluppo_room> _nullsuiluppo_roomCacheModel = new CacheModel<suiluppo_room>() {
			@Override
			public suiluppo_room toEntityModel() {
				return _nullsuiluppo_room;
			}
		};
}