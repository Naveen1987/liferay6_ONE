...
<%-- <portlet:param name="mvcPath" value="/html/attivita_formativa_corsi/AddCourse.jsp"/> --%> 
</portlet:actionURL>
...
<tr>
<td>Evento Progetto<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style="-webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px;" name="<portlet:namespace/>Evento_Progetto" class="form-control"  value="" id="Evento_Progetto"/>
...
<tr>
<td>Titolo<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Titolo"  class="form-control"  value="" id="Titolo">
...
<tr>
<td>Descrizione<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Descrizione"  class="form-control"  value="" id="Descrizione">
...
<tr>
<td>Nr Edizione<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Nr_Edizione"  class="form-control"  value="" id="Nr_Edizione">
...
<tr>
<td>Sede<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Sede"  class="form-control"  value="" id="Sede">
...
<tr>
<td>Abstract<span style="font-size:20px;color:red"><b>*</b></span></td><td><input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Abstract"  class="form-control"  value="" id="Abstract">
...
<td>
<input type="datetime" data-field="datetime" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " placeholder="<liferay-ui:message key="ClickforCalendar"/>" name="<portlet:namespace/>Data_Inizio-date" id="Data_Inizio-date" readonly="readonly">
...
<td>
<input type="datetime" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " data-field="datetime" placeholder="<liferay-ui:message key="ClickforCalendar"/>" id="Data_Fine-date" name="<portlet:namespace/>Data_Fine-date"  readonly="readonly">
...
<input  type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Tot_Ore"  class="form-control num-digit"  value="" id="Tot_Ore"><br/>
...
<td>Ammessi al corso<span style="font-size:20px;color:red"><b>*</b></span></td><td>
 <input type="text" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " id="Ammessi_al_corso" class="form-control num-digit" value=""  name="<portlet:namespace/>Ammessi_al_corso">
...
<div class="checkbox-container">
    <input type="checkbox"  id="Visibile" name="<portlet:namespace/>Visibile" checked>
</div>
...
<div class="checkbox-container">
    <input type="checkbox"  id="Bloccato" name="<portlet:namespace/>Bloccato">
</div>
<script type="text/javascript">
    new DG.OnOffSwitch({
        el: '#Bloccato',
...
<tr>
<td>Dispensa corso<span style="font-size:20px;color:red"><b>*</b></span></td><td> <input type="file" style=" -webkit-border-radius: 5px;  -moz-border-radius: 5px;     border-radius: 5px;    border: 1px solid #848484; outline:0;     height:25px;     width: 300px; " name="<portlet:namespace/>Dispensa_corso"  class="form-control"  value="" id="Dispensa_corso">
<br/><span  id="_Dispensa_corso" style="color:red; display:none"><liferay-ui:message key="addCourseError"/> Dispensa corso</span>
</td>
</tr>
<tr>
<td><br/></td>
...
<!-- Now Logic Here for message box -->
...
<script type="text/javascript">
  $("#reset").click(function(){
	 ...
	 $("#Data_Inizio-date").val("<liferay-ui:message key="ClickforCalendar"/>");
	 $("#Data_Fine-date").val("<liferay-ui:message key="ClickforCalendar"/>");
	 $("#Scadenza_Iscrizioni-date").val("<liferay-ui:message key="ClickforCalendar"/>");
	/*  alert($('#Visibile').prop('checked'));
	 alert($('#Bloccato').prop('checked')); */
	 /* $('#Visibile').prop('checked', true);
	 $('#Bloccato').prop('checked', true); */
	/*  $('#Visibile').attr('checked', true);
	 $('#Bloccato').attr('checked', true); */
