			...
			<table border="0" cellpadding="3" cellspacing="0">
				<tbody>
					<tr onclick="CheckSiss();Apri('http://le-psnet-p1.aol.it')">
						<td style="width: 36px;"><img src="<%=renderRequest.getContextPath().toString()%>/img/psnet.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 35px;" /></td>
						<td><b>PS-NET</b><br />
					...
					<tr onclick="CheckSiss();Apri('http://10.79.5.220:8081/fenix/')">
						<td><img alt="" src="<%=renderRequest.getContextPath().toString()%>/img/fenix.jpg" style="width: 36px; height: 34px;" /></td>
						<td><b>FENIX</b><br />
						<font color="#808080" style="font-size: 10px; font-style: italic">RIS Application</font></td>
					</tr>
					<tr onclick="HideC('dettaglioPACS')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/pacs.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></td>
					...
					<tr onclick="CheckSiss();Apri('http://le-acceweb-p2.aol.it')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/acceweb.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></td>
						<td><b>ACCEWEB</b><br />
					...
					<tr onclick="CheckSiss();Apri('http://le-cupnet-p3.aol.it')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/cupnet.jpg" style="border-width: 0px; border-style: solid; width: 27px; height: 36px;" /></td>
						<td><b>CUP-NET</b><br />
					...
					<tr onclick="Apri('http://le-ambnet-p1.aol.it')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/ricettario.jpg" style="border-width: 0px; border-style: solid; height: 36px; width: 29px;" /></td>
			...
			<table border="0" cellpadding="3" cellspacing="0">
				<tbody>
					<tr onclick="Apri('http://le-devsan-01.aol.it/REPOPL/')">
						<td style="width: 36px;"><img src="<%=renderRequest.getContextPath().toString()%>/img/postiletto.jpg" style="border-width: 0px; border-style: solid; width: 35px; height: 36px;" /></td>
					...
					<tr onclick="Apri('http://le-accenet-p1.aol.it')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/farmaci.jpg" style="border-width: 0px; border-style: solid; width: 32px; height: 36px;" /></td>
						<td><b>FILE F</b><br />
					...
					<tr onclick="CheckSiss();Apri('http://le-galileo-03.aol.it:9080/webmed/Applet/galileo.jnlp')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/galileo.jpg" style="border-width: 0px; border-style: solid; width: 27px; height: 36px;" /></td>
						<td><b>GALILEO</b><br />
					...
					<tr onclick="CheckSiss();Apri('http://le-bloope-00.aol.it:8090/ormaweb')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/ormaweb.jpg" style="border-width: 0px; border-style: solid; width: 24px; height: 36px;" /></td>
						<td><b>ORMAWeb</b><br />
					...
					<tr onclick="Apri('http://le-drgsrv-01.aol.it')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/codefinder.jpg" style="border-width: 0px; border-style: solid; width: 40px; height: 36px;" /></td>
					...
					<tr onclick="HideC('dettaglioRegione')">
						<td><img src="<%=renderRequest.getContextPath().toString()%>/img/link_esterni.jpg" style="border-width: 0px; border-style: solid; width: 36px; height: 36px;" /></td>
